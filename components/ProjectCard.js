...
const ProjectCard = ({Title, Description, Technologies, Link, Color}) => {
  return (
    <Card href={Link} className="!max-w-screen-md !min-w-72 justify-self-center !w-full transition ease-in-out hover:-translate-y-1 hover:scale-95 hover:dark:bg-emerald-800 hover:bg-amber-300 duration-300 border-2 border-black border-solid">
