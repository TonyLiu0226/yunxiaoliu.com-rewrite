...
const AboutCard = () => {
    return(
        <div>
        <h1 className={indexStyles.title}>About Me</h1>
      <div className="mx-0.5 w-full flex justify-center items-center"> 
    <Card className="!max-w-screen-xl !min-w-80 !w-full transition ease-in-out hover:-translate-y-1 hover:scale-110 hover:dark:bg-emerald-800 hover:bg-amber-300 duration-300" imgSrc="YL.png" horizontal>
